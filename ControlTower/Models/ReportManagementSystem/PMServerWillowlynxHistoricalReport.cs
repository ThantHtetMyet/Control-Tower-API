...
{
    public class PMServerWillowlynxHistoricalReport
    {
        [Key]
        ...
        [ForeignKey("WillowlynxHistoricalReportStatusID")]
        public virtual WillowlynxHistoricalReportStatus WillowlynxHistoricalReportStatus { get; set; }
