...
{
    public class PMServerHardDriveHealth
    {
        [Key]
        ...
        public virtual ICollection<PMServerHardDriveHealthDetails> PMServerHardDriveHealthDetails { get; set; } = new List<PMServerHardDriveHealthDetails>();
    }
}