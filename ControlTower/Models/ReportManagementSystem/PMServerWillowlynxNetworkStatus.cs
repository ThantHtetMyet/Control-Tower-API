...
{
    public class PMServerWillowlynxNetworkStatus
    {
        [Key]
        ...
        [ForeignKey("WillowlynxNetworkStatusID")]
        public virtual WillowlynxNetworkStatus WillowlynxNetworkStatus { get; set; }
