...
{
    public class PMServerWillowlynxCCTVCamera
    {
        [Key]
        ...
        [ForeignKey("WillowlynxCCTVCameraStatusID")]
        public virtual WillowlynxCCTVCameraStatus WillowlynxCCTVCameraStatus { get; set; }
