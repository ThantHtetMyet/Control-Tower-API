...
{
    public class PMServerWillowlynxProcessStatus
    {
        [Key]
        ...
        [Required]
        public Guid WillowlynxProcessStatusID { get; set; }
        ...
        [ForeignKey("WillowlynxProcessStatusID")]
        public virtual WillowlynxProcessStatus WillowlynxProcessStatus { get; set; }
